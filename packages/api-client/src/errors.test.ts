...
// session's room) — included here so the mapping is locked down. ROOM_IN_SESSION was added in
// Phase 4.7 (join_room, 0019, raises it once a session exists — the roster freeze).
