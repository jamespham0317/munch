 ...
 * nav chrome (10-pages.md §2); this gives them the brand row (which doubles as the way back to
 * the Match home), the cream canvas, an optional title/subtitle header, and a centered,
 * readable content column that reflows mobile↔desktop (09-design-system.md §6). Presentation
