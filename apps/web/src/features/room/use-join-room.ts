...
/**
 * Join-room flow: ensure a (guest) session, then call the join_room RPC by code
 * and route to the lobby. Mirrors useCreateRoom — see its note on the idempotent
 * session and the thrown-envelope pattern.
 */
